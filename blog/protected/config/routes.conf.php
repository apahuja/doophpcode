...
$route['*']['/signup'] = array('UserController', 'signup');
$route['*']['/saveNewUser'] = array('UserController', 'saveNewUser');

$route['*']['/login'] = array('UserController', 'login');
$route['*']['/checkUserLogin'] = array('UserController', 'checkUserLogin');

$route['*']['/logout'] = array('UserController', 'logout');

$route['*']['/removeUser'] = array('UserController', 'deleteUser');
